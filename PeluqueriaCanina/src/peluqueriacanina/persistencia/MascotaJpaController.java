...
public class MascotaJpaController implements Serializable {
    ...
    //Con este constructor cuando llamamos al JPA controller (controlador de JPA) que haga una nueva instacia, crea un administrador de entidades (emf)teniendo en cuenta las propiedades que hay en el persistence unit, osea toma propiedades de la conexion a la base de datos y las propiedades de las clases mapeadas como de persistencia
