...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    public ModificarDatos(int num_alumno) {
        control = new Controladora();
        this.num_alumno = num_alumno;
        initComponents();//Crea Interface gráfica
        cargarDatos(num_alumno);
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Modificación de Datos");
        ...
        btnGuardarCambios.setIcon(new javax.swing.ImageIcon("C:\\Users\\jdeslarmes\\Documents\\Personal\\Egg\\Javi\\Peluquería canina\\Guardar_boton.jpg")); // NOI18N
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addComponent(btnGuardarCambios, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(17, 17, 17))
        );
    ...
    private void btnGuardarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarCambiosActionPerformed
        ...
        //Todos los datos del alumno, familia y escuela
        ...
        control.modificarAlumno(alum, nombreAlumno, fechaNacimiento, dni, nombreFamiliar, dniFamiliar, telefonoFamiliar, domicilio, otrosDatos, 
    ...
    private void cargarDatos(int num_alumno) {
        
         this.alum= control.traerAlumno(num_alumno);
        
        txtNombreAlumno.setText(alum.getNombreAlumno());
        dateNacimiento.setDate(alum.getFechaNacimiento());
        txtDNI.setText(alum.getDni());
        txtNombreFamiliar.setText(alum.getUnaFamilia().getNombreFamiliar());
        txtTelefonoFamiliar.setText(alum.getUnaFamilia().getTelefonoFamiliar());
        txtDNIFamiliar.setText(alum.getUnaFamilia().getDniFamiliar());
        txtOtrosDatos.setText(alum.getUnaFamilia().getOtrosDatos());
        txtEscuela.setText(alum.getUnaEscuela().getEscuela());
        txtTelefonoEscuela.setText(alum.getUnaEscuela().getTelefonoEscuela());
        txtDocente.setText(alum.getDocente());
        txtDomicilio.setText(alum.getUnaFamilia().getDomicilio());
        
        if(alum.getUnaEscuela().getGrado().equals("Prescolar")){
            cmbGrado.setSelectedIndex(1);
        }else if (alum.getUnaEscuela().getGrado().equals("1")){
            cmbGrado.setSelectedIndex(2);
        }else if (alum.getUnaEscuela().getGrado().equals("2")){
            cmbGrado.setSelectedIndex(3);
        }else if (alum.getUnaEscuela().getGrado().equals("3")){
            cmbGrado.setSelectedIndex(4);
        }else if (alum.getUnaEscuela().getGrado().equals("4")){
            cmbGrado.setSelectedIndex(5);           
        }else if (alum.getUnaEscuela().getGrado().equals("5")){
            cmbGrado.setSelectedIndex(6);        
        }else if (alum.getUnaEscuela().getGrado().equals("6")){
            cmbGrado.setSelectedIndex(7);     
        }    
        if(alum.getTurno().equals("MAÑANA")){   
           cmbTurno.setSelectedIndex(1);
        }else if (alum.getTurno().equals("TARDE")){
